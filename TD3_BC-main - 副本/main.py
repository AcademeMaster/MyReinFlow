...
if __name__ == "__main__":
    ...
    # Multi-step action parameters
    parser.add_argument("--horizon", default=4, type=int)  # Multi-step action horizon
    parser.add_argument("--use_multi_step", action="store_true", default=True)  # Enable multi-step training
    # Online training
